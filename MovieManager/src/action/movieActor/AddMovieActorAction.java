...
public class AddMovieActorAction extends ActionSupport implements SessionAware{
	private BaseDao dao;
	private Ma ma;
	...
	public String addMovieActor() throws Exception {
		List list=dao.findMovieActor(role,moviename);
